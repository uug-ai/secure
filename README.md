...
Generated at `2026-08-19T04:01:09Z` from the newest tagged GHCR image available for each approved project. Scores use the highest detected severity: 100 clean, 80 low, 60 medium, 30 high, and 0 critical. An unavailable image is a coverage gap, not a clean result.

| Repository | Scan | Risk | Score | Tag | Critical | High | Medium | Low | Fixable C/H | Report |
| --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| [factory](https://github.com/uug-ai/factory) | scanned | High | 30/100 | latest | 0 | 25 | 9 | 0 | 0/24 | [Trivy](containers/factory/trivy.json) |
...
| [hub-api](https://github.com/uug-ai/hub-api) | scanned | High | 30/100 | latest | 0 | 26 | 10 | 0 | 0/24 | [Trivy](containers/hub-api/trivy.json) |
...
| [hub-pipeline-classifier](https://github.com/uug-ai/hub-pipeline-classifier) | scanned | Critical | 0/100 | latest | 23 | 270 | 1421 | 855 | 1/20 | [Trivy](containers/hub-pipeline-classifier/trivy.json) |
...
| [vault](https://github.com/uug-ai/vault) | scanned | High | 30/100 | latest | 0 | 23 | 9 | 0 | 0/22 | [Trivy](containers/vault/trivy.json) |
<!-- CONTAINER_SCAN_END -->

<!-- SBOM_QUALITY_START -->
## SBOM quality overview

Generated at `2026-08-20T02:41:34Z`. Quality combines document metadata (20%), package identity (30%), licensing (20%), provenance (15%), and relationships (15%).
...
| [hub-frontend](https://github.com/uug-ai/hub-frontend) | collected | 🟠 Needs work | 69/100 | 1315 | 100% | 99% | 100% | [Breakdown](sboms/hub-frontend/README.md) · [SPDX](sboms/hub-frontend/sbom.spdx.json) |
