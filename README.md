...
Generated at `2026-08-27T05:40:42Z` from the newest tagged GHCR image available for each approved project. Scores use the highest detected severity: 100 clean, 80 low, 60 medium, 30 high, and 0 critical. An unavailable image is a coverage gap, not a clean result.

| Repository | Scan | Risk | Score | Tag | Critical | High | Medium | Low | Fixable C/H | Report |
| --- | --- | --- | ---: | --- | ---: | ---: | ---: | ---: | ---: | --- |
| [factory](https://github.com/uug-ai/factory) | scanned | High | 30/100 | latest | 0 | 29 | 15 | 12 | 0/28 | [Trivy](containers/factory/trivy.json) |
| [hub-anpr](https://github.com/uug-ai/hub-anpr) | scanned | Critical | 0/100 | latest | 10 | 221 | 316 | 252 | 0/22 | [Trivy](containers/hub-anpr/trivy.json) |
| [hub-api](https://github.com/uug-ai/hub-api) | scanned | High | 30/100 | latest | 0 | 29 | 16 | 12 | 0/28 | [Trivy](containers/hub-api/trivy.json) |
| [hub-cleanup](https://github.com/uug-ai/hub-cleanup) | scanned | High | 30/100 | latest | 0 | 10 | 6 | 12 | 0/10 | [Trivy](containers/hub-cleanup/trivy.json) |
...
| [hub-loitering](https://github.com/uug-ai/hub-loitering) | scanned | High | 30/100 | latest | 0 | 26 | 14 | 12 | 0/26 | [Trivy](containers/hub-loitering/trivy.json) |
...
| [hub-objecttracking](https://github.com/uug-ai/hub-objecttracking) | scanned | High | 30/100 | latest-gpu | 0 | 42 | 586 | 109 | 0/42 | [Trivy](containers/hub-objecttracking/trivy.json) |
| [hub-pipeline-analysis](https://github.com/uug-ai/hub-pipeline-analysis) | scanned | High | 30/100 | latest | 0 | 24 | 13 | 12 | 0/24 | [Trivy](containers/hub-pipeline-analysis/trivy.json) |
| [hub-pipeline-classifier](https://github.com/uug-ai/hub-pipeline-classifier) | scanned | Critical | 0/100 | latest | 19 | 320 | 1471 | 904 | 1/20 | [Trivy](containers/hub-pipeline-classifier/trivy.json) |
...
| [hub-pipeline-dominantcolors](https://github.com/uug-ai/hub-pipeline-dominantcolors) | scanned | Critical | 0/100 | latest | 1 | 27 | 14 | 12 | 1/27 | [Trivy](containers/hub-pipeline-dominantcolors/trivy.json) |
...
| [hub-pipeline-monitor](https://github.com/uug-ai/hub-pipeline-monitor) | scanned | Critical | 0/100 | latest | 1 | 19 | 14 | 12 | 1/19 | [Trivy](containers/hub-pipeline-monitor/trivy.json) |
| [hub-pipeline-notification](https://github.com/uug-ai/hub-pipeline-notification) | scanned | High | 30/100 | latest | 0 | 17 | 9 | 0 | 0/16 | [Trivy](containers/hub-pipeline-notification/trivy.json) |
...
| [hub-pipeline-redaction](https://github.com/uug-ai/hub-pipeline-redaction) | scanned | High | 30/100 | latest | 0 | 33 | 440 | 53 | 0/33 | [Trivy](containers/hub-pipeline-redaction/trivy.json) |
...
| [hub-pipeline-thumbnail](https://github.com/uug-ai/hub-pipeline-thumbnail) | scanned | Critical | 0/100 | latest | 1 | 27 | 14 | 12 | 1/27 | [Trivy](containers/hub-pipeline-thumbnail/trivy.json) |
...
| [hub-workflows](https://github.com/uug-ai/hub-workflows) | scanned | High | 30/100 | latest | 0 | 24 | 13 | 12 | 0/24 | [Trivy](containers/hub-workflows/trivy.json) |
| [vault](https://github.com/uug-ai/vault) | scanned | High | 30/100 | latest | 0 | 20 | 15 | 12 | 0/19 | [Trivy](containers/vault/trivy.json) |
<!-- CONTAINER_SCAN_END -->

<!-- SBOM_QUALITY_START -->
## SBOM quality overview

Generated at `2026-08-28T05:00:24Z`. Quality combines document metadata (20%), package identity (30%), licensing (20%), provenance (15%), and relationships (15%).
